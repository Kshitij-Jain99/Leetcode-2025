...
// Approach C: Union Find or Disjoint set Union[Better than DFS]
// TC = O(N^2), SC = O(N^2)
/*Why better than before? -49 ms < before(95ms) almost half
 Island identification: Union-Find (less recursive overhead)
 size of of arr store: (direct access is faster)
 0s conversion : (fewer function calls)
 Union-Find (self-optimizing structure): Path compression (find()) speeds up future lookups
