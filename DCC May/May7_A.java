...
// TC = O( M.N.Log(MN) ), SC = O(M.N)
/*
 1. We cannot solve it by greedy approach because every time local mim. will not give us globlal mim. values.
 2. 
 */
import java.util.*;
...
public class May7_A {
    ...
    public int minTimeToReach(int[][] moveTime){
        ...
        // PQ to hold entries as (time, i, j)
